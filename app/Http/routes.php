...
Route::group( array('middleware'=>'web') ,function(){
    ...
    //semesters
    Route::get('/semester','DashboardController@index');
    Route::get('/semester/listAll/{id}','SemesterController@listAll');
    Route::post('/semester','SemesterController@create');
    Route::get('/semester/{id}','SemesterController@fetch');
    Route::post('/semester/delete/{id}','SemesterController@delete');
    Route::post('/semester/{id}','SemesterController@edit');

    //Quarters
    Route::get('/quarter','DashboardController@index');
    Route::get('/quarter/listAll/{id}','QuarterController@listAll');
    Route::post('/quarter','QuarterController@create');
    Route::get('/quarter/{id}','QuarterController@fetch');
    Route::post('/quarter/delete/{id}','QuarterController@delete');
    Route::post('/quarter/{id}','QuarterController@edit');

    //Weeks
    Route::get('/week','DashboardController@index');
    Route::get('/week/listAll/{id}','WeekController@listAll');
    Route::post('/week','WeekController@create');
    Route::get('/week/{id}','WeekController@fetch');
    Route::post('/week/delete/{id}','WeekController@delete');
    Route::post('/week/{id}','WeekController@edit');
    ...
    //BuildingTypes
    Route::get('/buildingType','DashboardController@index');
    Route::get('/buildingType/listAll','BuildingTypeController@listAll');
    Route::post('/buildingType','BuildingTypeController@create');
    Route::get('/buildingType/{id}','BuildingTypeController@fetch');
    Route::post('/buildingType/delete/{id}','BuildingTypeController@delete');
    Route::post('/buildingType/{id}','BuildingTypeController@edit');

    //Buildings
    Route::get('/building','DashboardController@index');
    Route::get('/building/listAll','BuildingController@listAll');
    Route::get('/building/listParents','BuildingController@listParents');
    Route::post('/building','BuildingController@create');
    Route::get('/building/{id}','BuildingController@fetch');
    Route::post('/building/delete/{id}','BuildingController@delete');
    Route::post('/building/{id}','BuildingController@edit');

    //Divisions
    Route::get('/division','DashboardController@index');
    Route::get('/division/listAll','DivisionController@listAll');
    Route::post('/division','DivisionController@create');
    Route::get('/division/{id}','DivisionController@fetch');
    Route::post('/division/delete/{id}','DivisionController@delete');
    Route::post('/division/{id}','DivisionController@edit');

    //Stages
    Route::get('/stage','DashboardController@index');
    Route::get('/stage/listAll/{id}','StageController@listAll');
    Route::post('/stage','StageController@create');
    Route::get('/stage/{id}','StageController@fetch');
    Route::post('/stage/delete/{id}','StageController@delete');
    Route::post('/stage/{id}','StageController@edit');

    //ClassAges
    Route::get('/classAge','DashboardController@index');
    Route::get('/classAge/listAll/{id}','ClassAgesController@listAll');
    Route::post('/classAge','ClassAgesController@create');
    Route::get('/classAge/{id}','ClassAgesController@fetch');
    Route::post('/classAge/delete/{id}','ClassAgesController@delete');
    Route::post('/classAge/{id}','ClassAgesController@edit');
