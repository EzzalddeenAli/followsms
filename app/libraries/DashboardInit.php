...
class DashboardInit
{
    ...
    public $calendarsLocale = ["ethiopic" => "am", "gregorian" => "en_US", "islamic" => "en_US", "persian" => "fa"];


    public function __construct()
    {
        $this->panelItems = [
            "dashboard"     => ["title" => "dashboard", "icon" => "mdi mdi-gauge", "url" => URL::to('#/'), "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "staticContent" => ["title"    => "staticPages", "icon" => "mdi mdi-book-multiple", "activated" => "staticpagesAct", "cusPerm" => "staticPages", "permissions" => ['admin', 'teacher', 'student', 'parent'],
                                "children" => [
                                    "controlStatic" => ["title" => "controlPages", "url" => URL::to('#/static'), "permissions" => ['admin']],
                                ],
            ],

            "messages" => ["title" => "Messages", "url" => URL::to('#/messages'), "icon" => "mdi mdi-message-text-outline", "activated" => "messagesAct", "permissions" => ['admin', 'teacher', 'student', 'parent']],

            "mailsms"  => ["title" => "mailsms", "url" => URL::to('#/mailsms'), "icon" => "mdi mdi-cellphone-iphone", "activated" => "mailSmsAct", "cusPerm" => "mailsms", "permissions" => ['admin', 'teacher']],
            "mobNotif" => ["title" => "Mobile Notifications", "url" => URL::to('#/mobileNotif'), "icon" => "mdi mdi-telegram", "activated" => "sendNotifAct", "cusPerm" => "mobileNotif", "permissions" => ['admin']],

            "calender"      => ["title" => "Calender", "url" => URL::to('#/calender'), "icon" => "mdi mdi-calendar-text", "activated" => "calendarAct", "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "classSchedule" => ["title" => "classSch", "url" => URL::to('#/classschedule'), "icon" => "mdi mdi-timelapse", "activated" => "classSchAct", "cusPerm" => "classSch", "permissions" => ['admin', 'teacher', 'student', 'parent']],

            "attendance"      => ["title" => "Attendance", "icon" => "mdi mdi-check-all", "activated" => "attendanceAct", "cusPerm" => "Attendance", "url" => URL::to('#/attendance'), "permissions" => ['admin', 'teacher']],
            "vacation"        => ["title" => "Vacation", "url" => URL::to('#/vacation'), "icon" => "mdi mdi-airplane", "activated" => "vacationAct", "permissions" => ['teacher', 'student']],
            "myAttendance"    => ["title" => "Attendance", "url" => URL::to('#/attendanceStats'), "icon" => "mdi mdi-check", "activated" => "attendanceAct", "permissions" => ['student', 'parent']],
            "staffAttendance" => ["title" => "staffAttendance", "url" => URL::to('#/staffAttendance'), "icon" => "mdi mdi-check", "activated" => "staffAttendanceAct", "cusPerm" => "staffAttendance", "permissions" => ['admin']],

            "hostel" => [
                "title"    => "HostelManage", "icon" => "mdi mdi-home-map-marker", "activated" => "hostelAct", "cusPerm" => "HostelManage", "permissions" => ['admin'],
                "children" => [
                    "controlHostel" => ["title" => "Hostel", "url" => URL::to('#/hostel'), "permissions" => ['admin']],
                    "hostelCat"     => ["title" => "HostelCat", "url" => URL::to('#/hostelCat'), "permissions" => ['admin']],
                ],
            ],

            "library" => ["title" => "Library", "url" => URL::to('#/library'), "icon" => "mdi mdi-library", "activated" => "bookslibraryAct", "cusPerm" => "Library", "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "media"   => ["title" => "mediaCenter", "url" => URL::to('#/media'), "icon" => "mdi mdi-folder-multiple-image", "activated" => "mediaAct", "cusPerm" => "mediaCenter", "permissions" => ['admin', 'teacher', 'student', 'parent']],

            "teachers" => ["title" => "teachers", "url" => URL::to('#/teachers'), "icon" => "mdi mdi-briefcase", "cusPerm" => "teachers", "permissions" => ['admin']],
            "students" => ["title" => "students", "url" => URL::to('#/students'), "icon" => "mdi mdi-account-multiple-outline", "cusPerm" => "students", "permissions" => ['admin', 'teacher', 'parent']],
            "parents"  => ["title" => "parents", "url" => URL::to('#/parents'), "icon" => "mdi mdi-account-multiple", "cusPerm" => "parents", "permissions" => ['admin']],

            "studentsMarksheet" => ["title" => "Marksheet", "url" => URL::to('#/students/marksheet'), "icon" => "mdi mdi-grid", "permissions" => ['student']],

            "gradelevels" => ["title" => "gradeLevels", "url" => URL::to('#/gradeLevels'), "icon" => "mdi mdi-arrange-send-backward", "cusPerm" => "gradeLevels", "permissions" => ['admin']],
            "materials"   => ["title" => "studyMaterial", "url" => URL::to('#/materials'), "icon" => "mdi mdi-cloud-download", "activated" => "materialsAct", "cusPerm" => "studyMaterial", "permissions" => ['admin', 'teacher', 'student']],
            "assignments" => ["title" => "Assignments", "url" => URL::to('#/assignments'), "icon" => "mdi mdi-file-pdf", "activated" => "assignmentsAct", "cusPerm" => "Assignments", "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "examslist"   => ["title" => "examsList", "url" => URL::to('#/examsList'), "icon" => "mdi mdi-playlist-check", "cusPerm" => "examsList", "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "onlineexams" => ["title" => "onlineExams", "url" => URL::to('#/onlineExams'), "icon" => "mdi mdi-account-network", "activated" => "onlineexamsAct", "cusPerm" => "onlineExams", "permissions" => ['admin', 'teacher', 'student']],

            "newsboard" => ["title" => "newsboard", "url" => URL::to('#/newsboard'), "icon" => "mdi mdi-bullhorn", "activated" => "newsboardAct", "cusPerm" => "newsboard", "permissions" => ['admin', 'teacher', 'student', 'parent']],
            "events"    => ["title" => "events", "url" => URL::to('#/events'), "icon" => "mdi mdi-calendar-clock", "activated" => "eventsAct", "cusPerm" => "events", "permissions" => ['admin', 'teacher', 'student', 'parent']],

            "accounting" => ["title"    => "accounting", "icon" => "mdi mdi-currency-usd", "activated" => "paymentsAct", "cusPerm" => "accounting", "permissions" => ['admin', 'student', 'parent', 'account'],
                             "children" => [
                                 "controlFeeGroups"     => ["title" => "FeeGroups", "url" => URL::to('#/feeGroup'), "activated" => "paymentsAct", "permissions" => ['admin', 'account']],
                                 "controlFeeTypes"      => ["title" => "FeeTypes", "url" => URL::to('#/feeType'), "activated" => "paymentsAct", "permissions" => ['admin', 'account']],
                                 "controlFeeAllocation" => ["title" => "FeeAllocation", "url" => URL::to('#/feeAllocation'), "activated" => "paymentsAct", "permissions" => ['admin', 'account']],
                                 "Invoices"             => ["title" => "Invoices", "url" => URL::to('#/invoices'), "activated" => "paymentsAct", "permissions" => ['admin', 'student', 'parent', 'account']],
                                 "DueInvoices"          => ["title" => "dueInvoices", "url" => URL::to('#/invoices/due'), "activated" => "paymentsAct", "permissions" => ['admin', 'student', 'parent', 'account']],
                             ],
            ],

            "expensesList" => ["title"    => "Expenses", "icon" => "mdi mdi-currency-usd", "activated" => "paymentsAct", "cusPerm" => "accounting", "permissions" => ['admin', 'account'],
                               "children" => [
                                   "expenses"    => ["title" => "Expenses", "url" => URL::to('#/expenses'), "permissions" => ['admin', 'account']],
                                   "expensesCat" => ["title" => "Expenses Categories", "url" => URL::to('#/expensesCat'), "permissions" => ['admin', 'account']],
                               ],
            ],


            "transportations" => ["title" => "Transportation", "url" => URL::to('#/transports'), "icon" => "mdi mdi-bus", "activated" => "transportAct", "cusPerm" => "Transportation", "permissions" => ['admin', 'teacher', 'student', 'parent']],

            "classes" => [
                "title"    => "classes", "icon" => "mdi mdi-sitemap", "cusPerm" => "classes", "permissions" => ['admin'],
                "children" => [
                    "divisions" => ["title" => "Divisions", "url" => URL::to('#/division'), "permissions" => ['admin']],
            ...
            "subjects" => ["title" => "Subjects", "url" => URL::to('#/subjects'), "icon" => "mdi mdi-book-open-page-variant", "cusPerm" => "Subjects", "permissions" => ['admin']],
            "reports"  => ["title" => "Reports", "url" => URL::to('#/reports'), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct", "cusPerm" => "Reports", "permissions" => ['admin', 'account']],
            "Academic" => [
                "title"    => "Academic", "icon" => "mdi mdi-briefcase-check", "url" => URL::to('#/academicYear'), "cusPerm" => "academicyears", "permissions" => ['admin'],
                "children" => [
                    "academicyear" => ["title" => "academicyears", "url" => URL::to('#/academicYear'), "permissions" => ['admin']],
                    "semesters"    => ["title" => "Semester", "url" => URL::to('#/semester'), "permissions" => ['admin']],
                    "quarter"      => ["title" => "Quarter", "url" => URL::to('#/quarter'), "permissions" => ['admin']],
                    "week"         => ["title" => "Week", "url" => URL::to('#/week'), "permissions" => ['admin']],
                ],

            ],

            "BuildingStructure" => [
                "title"    => "Building Structure", "icon" => "mdi mdi-domain", "url" => URL::to('#/building'), "permissions" => ['admin'],
                "children" => [
                    "Building"      => ["title" => "Buildings", "url" => URL::to('#/building'), "permissions" => ['admin']],
                    "BuildingTypes" => ["title" => "BuildingTypes", "url" => URL::to('#/buildingType'), "permissions" => ['admin']],
                ],

            ],

            "adminTasks" => [
                "title"    => "adminTasks", "icon" => "mdi mdi-settings", "permissions" => ['admin'],
                "children" => [

                    "promotion"        => ["title" => "Promotion", "url" => URL::to('#/promotion'), "cusPerm" => "Promotion", "permissions" => ['admin']],
                    "mailsmsTemplates" => ["title" => "mailsmsTemplates", "url" => URL::to('#/mailsmsTemplates'), "cusPerm" => "mailsmsTemplates", "permissions" => ['admin']],
                    "polls"            => ["title" => "Polls", "url" => URL::to('#/polls'), "activated" => "pollsAct", "cusPerm" => "Polls", "permissions" => ['admin']],
                    "dormitories"      => ["title" => "Dormitories", "url" => URL::to('#/dormitories'), "cusPerm" => "Dormitories", "permissions" => ['admin']],
                    "siteSettings"     => ["title" => "generalSettings", "url" => URL::to('#/settings'), "cusPerm" => "generalSettings", "permissions" => ['admin']],
                    "languages"        => ["title" => "Languages", "url" => URL::to('#/languages'), "cusPerm" => "Languages", "permissions" => ['admin']],
                    "admins"           => ["title" => "Administrators", "url" => URL::to('#/admins'), "cusPerm" => "Administrators", "permissions" => ['admin']],
                    "accountants"      => ["title" => "accountants", "url" => URL::to('#/accountants'), "cusPerm" => "Administrators", "permissions" => ['admin']],
                    "terms"            => ["title" => "schoolTerms", "url" => URL::to('#/terms'), "cusPerm" => "generalSettings", "permissions" => ['admin']],
                ],
            ],
        ];
        ...
        foreach ($staticPages as $pages) {
            $this->panelItems['staticContent']['children'][md5(uniqid())] = ["title" => $pages->pageTitle, "url" => URL::to('#/static') . "/" . $pages->id, "icon" => "fa fa-file-text", "permissions" => ['admin', 'teacher', 'student', 'parent']];
        }
        ...
        if (count($language) == 0) {
            $language = languages::whereIn('id', [$defLang_, 1])->get();
        }
        ...
        $this->weekdays = ["ethiopic"  => [1 => 'እሑድ', 2 => 'ሰኞ', 3 => 'ማክሰኞ', 4 => 'ረቡዕ', 5 => 'ሓሙስ', 6 => 'ዓርብ', 7 => 'ቅዳሜ'],
                           "gregorian" => [1 => $this->language['Sunday'], 2 => $this->language['Monday'], 3 => $this->language['Tuesday'], 4 => $this->language['Wednesday'], 5 => $this->language['Thurusday'], 6 => $this->language['Friday'], 7 => $this->language['Saturday']],
                           "islamic"   => [1 => 'Yawm as-sabt', 2 => 'Yawm al-ahad', 3 => 'Yawm al-ithnayn', 4 => "Yawm ath-thulaathaa'", 5 => "Yawm al-arbi'aa'", 6 => "Yawm al-khamīs", 7 => "Yawm al-jum'a"],
                           "persian"   => [1 => 'Shambe', 2 => 'Yekshambe', 3 => 'Doshambe', 4 => 'Seshambe', 5 => 'Chæharshambe', 6 => 'Panjshambe', 7 => "Jom'e"],
        ];
        ...
        if (Session::has('selectAcYear')) {
            ...
            $this->currentAcademicYear = $currentAcademicYear->yearTitle;
        } else {
            $currentAcademicYear       = academic_year::where('isDefault', '1')->first();
            $this->currentAcademicYear = $currentAcademicYear->yearTitle;
    ...
    public function collectFees()
    {
        ...
        if ($fee_allocation->count() > 0) {
            ...
            while (list(, $value) = each($fee_allocation)) {
                $updateAllocationArray[$value['id']] = [];
                ...
                if (!isset($feeTypeList[$value['feeType']])) {
                    ...
                    if ($feeType->count() > 0) {
                        ...
                        $updateGroupArray[$feeTypeList[$value['feeType']]['id']]          = [];
                ...
                if (!isset($feeTypeList[$value['feeType']])) {
                    ...
                    $paymentRows   = [];
                    $paymentRows[] = ["title" => $feeTypeList[$value['feeType']]['feeTitle'], "amount" => $feeTypeList[$value['feeType']]['feeAmount']];
        ...
        if (count($updateGroupArray) > 0) {
            while (list($key, $value) = each($updateGroupArray)) {
                \fee_group::where('id', $value['group'])->update(['invoice_count' => $value['count']]);
            }
        }
    ...
    public function dueInvoicesNotif()
    {
        ...
        if ($dueInvoices->count() > 0) {
                    ...
                    if (is_array($value['parentOf'])) {
                        ...
                        while (list(, $value2) = each($value['parentOf'])) {
                            if (!isset($parentsArray[$value2['id']])) {
                                $parentsArray[$value2['id']] = [];
                            }
                            $parentsArray[$value2['id']][] = ["id" => $value['id'], "role" => $value['role'], "email" => $value['email'], "mobileNo" => $value['mobileNo'], "comVia" => $value['comVia'], "fullName" => $value['fullName']];
                        }
            ...
            while (list(, $value) = each($dueInvoices)) {
                ...
                if (isset($students)) {
                    ...
                    if (isset($mail) AND strpos($studentsArray[$value['paymentStudent']]['comVia'], 'mail') !== false) {
                        ...
                        $searchArray           = ["{name}", "{invoice_id}", "{invoice_details}", "{invoice_amount}", "{invoice_date}"];
                        $replaceArray          = [$studentsArray[$value['paymentStudent']]['fullName'], $value['paymentTitle'], $value['paymentDescription'], $this->settingsArray['currency_symbol'] . $value['paymentAmount'], $this->unix_to_date($value['paymentDate'])];
                ...
                if (isset($parents) AND isset($parentsArray[$value['paymentStudent']])) {
                    ...
                    while (list(, $parent) = each($parentsArray[$value['paymentStudent']])) {
                        if (isset($mail) AND strpos($parent['comVia'], 'mail') !== false) {
                            $temp_mailsms_template = $mailsms_template;
                            $searchArray           = ["{name}", "{invoice_id}", "{invoice_details}", "{invoice_amount}", "{invoice_date}"];
                            $replaceArray          = [$parent['fullName'], $value['paymentTitle'], $value['paymentDescription'], $this->settingsArray['currency_symbol'] . $value['paymentAmount'], $this->unix_to_date($value['paymentDate'])];
                            $sendTemplate          = str_replace($searchArray, $replaceArray, $temp_mailsms_template['templateMail']);
            ...
            if (count($updateInvoices) > 0) {
                \payments::whereIn('id', $updateInvoices)->update(['dueNotified' => '1']);
            }
        }
    ...
    public function gregTsDow($start, $end = "")
    {
        ...
        if ($end == "") {
            ...
            $return[] = ["dow" => $dd->format('N'), "date" => $start, "timestamp" => $dd->getTimestamp()];
        } else {
            ...
            $outArray = [];
            do {
                $return[] = ["dow" => $tmpDate->format('N'), "date" => $tmpDate->format($format), "timestamp" => $tmpDate->getTimestamp()];
    ...
    public function intlTsDow($start, $end = "")
    {
        ...
        if ($end == "") {
            ...
            $return[]          = ["dow" => $IntlDateFormatter->format($DateTime), "date" => $start, "timestamp" => $timestamp];
        } else {
            do {
                if (!isset($firstTime)) {
