schoex.config(function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.when('/', {
        ...
        .when('/semester', {
            templateUrl: 'assets/templates/semester.html',
        ...
        .when('/quarter', {
            templateUrl: 'assets/templates/quarter.html',
        ...
        .when('/buildingType', {
            templateUrl: 'assets/templates/buildingType.html',
            ...
            templateUrl: 'assets/templates/building.html',
        ...
        .when('/division', {
            templateUrl: 'assets/templates/division.html',
        ...
        .when('/stage', {
            templateUrl: 'assets/templates/stage.html',
        ...
        .when('/classAge', {
            templateUrl: 'assets/templates/classAges.html',
            controller: 'classAgeController',
            resolve: {
                essentialData: function (srvLibrary) {
                    return srvLibrary.getEssentials();
                }
        ...
        compile: function (element, attrs) {
            return function (scope, slider, attrs, controller) {
                ...
                if (typeof dateformatVal === "undefined") {
                     dateformatVal = $rootScope.dashboardData.dateformat;
                }
