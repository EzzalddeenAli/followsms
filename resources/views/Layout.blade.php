...
<head>
    ...
    <link href="{{URL::asset('assets/plugins/bootstrap-rtl-master/dist/css/custom-bootstrap-rtl.css')}}"
    ...
    <link href="{{URL::asset('assets/plugins/global-calendars/jquery.calendars.picker.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{URL::asset('assets/plugins/select2/dist/css/select2.css')}}" rel="stylesheet"
          type="text/css"/>
...
<body class="fix-header <?php if ($panelInit->settingsArray['leftmenuScroller'] == "e") {
    echo "fix-sidebar";
} ?> card-no-border" ng-app="schoex" ng-controller="mainController">
<!-- ============================================================== -->
...
<div id="main-wrapper">
    ...
    <!-- ============================================================== -->
    <header class="topbar <?php if ($panelInit->settingsArray['leftmenuScroller'] == "e") {
        echo "topbarSticky";
    } ?> no-print">
        <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <a class="navbar-brand" href="#/">
                    ...
                    <span>
                                <span class="dark-logo"
                                      ng-show="$root.dashboardData.baseUser.defTheme.indexOf('dark') == -1"><?php echo $panelInit->settingsArray['siteTitle']; ?></span>
                    ...
                    <span>
                                <span class="dark-logo"
                                      ng-show="$root.dashboardData.baseUser.defTheme.indexOf('dark') == -1"><?php echo $panelInit->settingsArray['siteLogoAdditional']; ?></span>
                                <span class="light-logo"
                                      ng-show="$root.dashboardData.baseUser.defTheme.indexOf('dark') !== -1"><?php echo $panelInit->settingsArray['siteLogoAdditional']; ?></span>
                            </span>
                    <?php
                    ...
                    ?>
                    <span>
                                <img src="<?php echo URL::asset('assets/images/logo-dark.png'); ?>" alt="homepage"
                                     class="dark-logo"/>
                                <img src="<?php echo URL::asset('assets/images/logo-light.png'); ?>" class="light-logo"
                                     alt="homepage"/>
                            </span>
                    <?php
                    }
            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav mr-auto mt-md-0 ">
                    ...
                    <!-- Topbar Left Icons //Rabie -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i
                                    class="mdi mdi-message"></i>
                            <!-- remove this "notify" div when no new messages <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div> -->
                        </a>
                                ...
                                <li>
                                    <div class="slimScrollDiv"
                                        ...
                                        <div class="slimScrollBar"
                                             style="background: rgb(220, 220, 220); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 192.901px;"></div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="slimScrollDiv"
                                        ...
                                        <div class="slimScrollBar"
                                             style="background: rgb(220, 220, 220); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 183.284px;"></div>
                                        <div class="slimScrollRail"
                                             style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
                                    </div>
                                </li>
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="javascript:void(0)"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{URL::to('/dashboard/profileImage/'.$users['id'])}}" alt="user"
                                    class="profile-pic"/></a>
                            ...
                            <ul class="dropdown-user">
                                <li>
                                    <div class="dw-user-box">
                                        <div class="u-img"><img
                                                    src="{{URL::to('/dashboard/profileImage/'.$users['id'])}}"
                                                    alt="user"></div>
                                        <div class="u-text">
                                ...
                                <a href="#/account/invoices" class="dropdown-item"><i
                                            class="ti-wallet"></i> <?php echo $panelInit->language['myInvoices']; ?></a>
                                <a href="#/messages" class="dropdown-item"><i
                                            class="ti-email"></i> <?php echo $panelInit->language['Messages']; ?></a>
                                <div class="dropdown-divider"></div>
                                <a href="#/account" class="dropdown-item"><i
                                            class="ti-settings"></i> <?php echo $panelInit->language['AccountSettings']; ?>
                                </a>
                                <div class="dropdown-divider"></div>
                                <a href="{{URL::to('/logout')}}" class="dropdown-item"><i
                                            class="fa fa-power-off"></i> <?php echo $panelInit->language['logout']; ?>
                                </a>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu  dropdown-menu-right">
                            ...
                            <a class="dropdown-item <?php if ($value->id == $users['defLang']) {
                                echo "active";
                            } ?>"
                               ng-click="changeLang('<?php echo $value->id; ?>')"><?php echo $value->languageTitle; ?></a>
                            <?php } ?>
                        </div>
                    </li>
                    <?php } ?>
                    ...
                    <li class="nav-item dropdown">
                        <a href="{{URL::to('/logout')}}" class="nav-link text-muted waves-effect waves-dark"> <i
                                    class="fa fa-power-off"></i></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="right-side-toggle text-muted nav-link " href="" data-toggle="dropdown"
    ...
    <!-- ============================================================== -->
    <aside class="left-sidebar <?php if ($panelInit->settingsArray['leftmenuScroller'] == "e") {
        echo "enableSlimScroller";
    } ?> no-print" style="padding-bottom:60px;">
        ...
        <!-- User profile image
            ...
            <table class="table info-table">
                ...
                <tr>
                    <td>Division:</td>
                    <td>Division Name Here</td>
                </tr>

                <tr>
                    <td>Active Year:</td>
                    <td>{{$panelInit->currentAcademicYear}}</td>
                </tr>
            </table>
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" <?php if ($panelInit->settingsArray['leftmenuScroller'] != "e") {
                    ...
                    while (list($key, $value) = each($panelInit->panelItems)) {
                        if (isset($value['activated']) AND !strpos($panelInit->settingsArray['activatedModules'], $value['activated'])) {
                            continue;
                        }
                        ...
                        if (isset($value['children'])) {
                            ...
                            while (list($key2, $value2) = each($value['children'])) {
                                if (isset($value2['activated']) AND !strpos($panelInit->settingsArray['activatedModules'], $value2['activated'])) {
                                    continue;
                                }
        ...
        <div class="sidebar-footer">
            <!-- item-->
            <a href="{{URL::to('#/account')}}" class="link" data-toggle="tooltip"
               title="<?php echo $panelInit->language['AccountSettings']; ?>"><i class="ti-settings"></i></a>
            <!-- item-->
            <a href="{{URL::to('#/messages')}}" class="link" data-toggle="tooltip"
               title="<?php echo $panelInit->language['Messages']; ?>"><i class="mdi mdi-gmail"></i></a>
            <!-- item-->
            <a href="{{URL::to('/logout')}}" class="link" data-toggle="tooltip"
               title="<?php echo $panelInit->language['logout']; ?>"><i class="mdi mdi-power"></i></a>
        </div>
        <!-- End Bottom points-->
    </aside>
    <!-- ============================================================== -->
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="right-sidebar">
                <div class="slimscrollright">
                    <div class="rpanel-title"> <?php echo $panelInit->language['servicePanel']; ?> <span><i
                    ...
                    <div class="r-panel-body">
                        ...
                        <ul id="themecolors" class="m-t-20">
                            ...
                            <li><a ng-click="changeTheme('default')" href="javascript:void(0)" data-theme="default"
                                   class="default-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'default'}">1</a></li>
                            <li><a ng-click="changeTheme('green')" href="javascript:void(0)" data-theme="green"
                                   class="green-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'green'}">2</a></li>
                            <li><a ng-click="changeTheme('red')" href="javascript:void(0)" data-theme="red"
                                   class="red-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'red'}">3</a></li>
                            <li><a ng-click="changeTheme('blue')" href="javascript:void(0)" data-theme="blue"
                                   class="blue-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'blue'}">4</a></li>
                            <li><a ng-click="changeTheme('purple')" href="javascript:void(0)" data-theme="purple"
                                   class="purple-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'purple'}">5</a></li>
                            <li><a ng-click="changeTheme('megna')" href="javascript:void(0)" data-theme="megna"
                                   class="megna-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'megna'}">6</a></li>
                            <li class="d-block m-t-30"><b><?php echo $panelInit->language['darkSidebar']; ?></b></li>
                            <li><a ng-click="changeTheme('default-dark')" href="javascript:void(0)"
                                   data-theme="default-dark" class="default-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'default-dark'}">7</a>
                            </li>
                            <li><a ng-click="changeTheme('green-dark')" href="javascript:void(0)"
                                   data-theme="green-dark" class="green-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'green-dark'}">8</a>
                            </li>
                            <li><a ng-click="changeTheme('red-dark')" href="javascript:void(0)" data-theme="red-dark"
                                   class="red-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'red-dark'}">9</a></li>
                            <li><a ng-click="changeTheme('blue-dark')" href="javascript:void(0)" data-theme="blue-dark"
                                   class="blue-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'blue-dark'}">10</a>
                            </li>
                            <li><a ng-click="changeTheme('purple-dark')" href="javascript:void(0)"
                                   data-theme="purple-dark" class="purple-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'purple-dark'}">11</a>
                            </li>
                            <li><a ng-click="changeTheme('megna-dark')" href="javascript:void(0)"
                                   data-theme="megna-dark" class="megna-dark-theme"
                                   ng-class="{'working':$root.dashboardData.baseUser.defTheme == 'megna-dark'}">12</a>
                            </li>
                        </ul>
                        <?php } ?>
                        <br/>
                        ...
                        <form class="form">
                            <div class="form-group m-t-10 row">
                                <div class="col-12">
                                    <select class="form-control" id="selectedAcYear"
                                            ng-model="dashboardData.selectedAcYear">
                                        <option ng-selected="year.id == '<?php echo $panelInit->selectAcYear; ?>'"
                                                ng-repeat="year in $root.dashboardData.academicYear"
                                                value="@{{year.id}}" ng-if="year.isDefault == '0'">@{{year.yearTitle}}
                                        </option>
                                        <option ng-selected="year.id == '<?php echo $panelInit->selectAcYear; ?>'"
                                                ng-repeat="year in $root.dashboardData.academicYear"
                                                value="@{{year.id}}" ng-if="year.isDefault == '1'">@{{year.yearTitle}} -
                                            Default Year
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-12">
                                    <button class="btn btn-success btn-flat pull-right ng-binding"
                                            ng-click="chgAcYear()"><?php echo $panelInit->language['chgYear']; ?></button>
                                </div>
                            </div>
                        </form>
                        <?php } ?>
        ...
        <footer class="footer"
                <?php if($panelInit->settingsArray['leftmenuScroller'] != "e"){ ?> style='position:fixed !important;' <?php } ?>>
            <?php echo $panelInit->settingsArray['footer']; ?> - <a target="_BLANK"
                                                                    href="{{URL::to('/terms')}}"><?php echo $panelInit->language['schoolTerms']; ?></a>
        </footer>
    </div>
...
<script src="{{URL::asset('assets/plugins/select2/dist/js/select2.js')}}"></script>
...
<script type="text/javascript"
        src="{{URL::asset('assets/plugins/global-calendars/jquery.calendars.'.$gcalendar.'.min.js')}}"></script>
<?php } ?>

<!-- Rabie include treeview-->
<script src="{{URL::asset('assets/plugins/bootstrap-treeview-master/dist/bootstrap-treeview.min.js')}}"></script>
<script src="{{URL::asset('assets/plugins/bootstrap-treeview-master/dist/bootstrap-treeview-init.js')}}"></script>
...
<script src="{{URL::asset('assets/js/Angular/added-app.js')}}"></script>
